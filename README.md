...
2. **[Robust stereo matching with improved graph and surface models and occlusion handling(JVCI2010)](https://www.sciencedirect.com/science/article/pii/S1047320310000350)**  
3. **[A Fast Dense Stereo Matching Algorithm with an Application to 3D Occupancy Mapping using Quadrocopters(ICRA2015)](https://ieeexplore.ieee.org/document/7251515)**  
